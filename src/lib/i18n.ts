...
export const translations = {
  en: {
    ...
    donate: {
      ...
      qcdDesc: "To make a QCD, reach out to your brokerage firm/financial advisor to initiate the transfer.",
  ...
  es: {
    ...
    donate: {
      ...
      qcdDesc: "Para realizar una QCD, comuníquese con su firma de corretaje/asesor financiero para iniciar la transferencia.",
      qcdAttn: "ATTN: Treasurer, SVDP Mother of Hope Conference",
